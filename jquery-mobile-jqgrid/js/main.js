$(document).ready(function() {
    ...
    var grid = $('#positions-table').jqGrid({
        ...
        'rowNum':20,
        'height':400,
        'colNames':['Security','Symbol', 'Quantity', 'Last Trade','Market Value',
                    'Price Paid','Total Cost','Gain','Gain %'],
        'colModel':[
               ...
               {name:'lastTrade',index:'lastTrade', width:131, align:'right',formatter:'currency',
                    formatoptions:{prefix: '$'},classes:'notimp currency'},
               {name:'marketValue',index:'marketValue', width:131, align:'right',formatter:'currency',
                    formatoptions:{prefix: '$'},classes:'currency'},
               {name:'pricePaid',index:'pricePaid', width:131,align:'right',formatter:'currency',
                    formatoptions:{prefix: '$'},classes:'notimp currency'},
               {name:'totalCost',index:'totalCost', width:131, sortable:false,formatter:'currency',
                    formatoptions:{prefix: '$'},classes:'notimp currency'},
               {name:'gain',index:'gain', width:131, sortable:false,formatter:'currency',
                    formatoptions:{prefix: '$'},classes:'positive currency'},
               {name:'gainPercent',index:'gainPercent', width:131, sortable:false,formatter:'number',
                    classes:'positive number'}
           ],
        'datatype': 'local',
        'data': positions,
